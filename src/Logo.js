        ...
        viewBox="0 0 50 50.25">
          ...
          >
              <g id="Layer_1" data-name="Layer 1">
                <path d="M25,1A24,24,0,1,1,1,25,24,24,0,0,1,25,1m0-1h0A25.07,25.07,0,0,0,0,25H0A25.07,25.07,0,0,0,25,50h0A25.07,25.07,0,0,0,50,25h0A25.07,25.07,0,0,0,25,0Z"/>
              </g>
            <motion.g
                animate={{ rotate: 360 }}
                transition={{
            ...
            >
              ...
              <g id="Layer_5" data-name="Layer 5">
                <path 
                  style={{fill:'none',stroke:'#000',strokeLinecap:'round',
                  strokeMiterlimit:10,strokeWidth:'3.5px'}} 
          ...
          <g id="Layer_4" data-name="Layer 4">
            <rect x="0.25" y="38" width="2.5" height="12" rx="1"/>
          </g>
          <g id="Layer_4_copy" data-name="Layer 4 copy">
            <rect x="42.5" y="43" width="2.5" height="12" rx="1" transform="translate(-5.25 92.75) rotate(-90)"/>
          </g>
          </svg>
    </div>
  );
